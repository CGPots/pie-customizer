...
STRINGS = {
    "RU": {
        ...
        "mirror_x_added": "Добавлены Mirror X и Empty у 3D-курсора; удалено выделенных граней",
    },
    "EN": {
        "apply": "Apply",
        ...
        "mirror_x_added": "Mirror X and a 3D Cursor Empty added; selected faces removed",
    },
}
...
_RU_NATIVE_TRANSLATIONS = {
    ...
    "Add Mirror X from 3D Cursor and Clean Seam": "Добавить зеркало X от 3D-курсора и очистить стык",
    "Create a Plain Axes Empty at the 3D Cursor, use it as the Mirror Object, and delete selected or automatically detected seam faces": "Создать Empty Plain Axes у 3D-курсора, назначить его как Mirror Object и удалить выбранные либо автоматически найденные стыковые грани",
