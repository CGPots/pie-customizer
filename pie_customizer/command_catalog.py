...
VIEWPORT_TOGGLE_ACTIONS = (
    ...
    *_property_actions(
        ...
        (
            ...
            ("align_rotation", "use_snap_align_rotation", "Привязка: Выравнивать вращение", "Snap: Align Rotation", "ORIENTATION_NORMAL"),
            ("absolute_grid", "use_snap_grid_absolute", "Привязка: Абсолютный шаг сетки", "Snap: Absolute Grid", "GRID"),
            ...
            ("backface_culling", "use_snap_backface_culling", "Привязка: Игнорировать обратные грани", "Snap: Backface Culling", "FACESEL"),
            ("active", "use_snap_self", "Привязка: К активному", "Snap: Active", "OBJECT_DATA"),
            ("edited", "use_snap_edit", "Привязка: К редактируемому", "Snap: Edited", "EDITMODE_HLT"),
            ("nonedited", "use_snap_nonedit", "Привязка: К нередактируемому", "Snap: Non-Edited", "OBJECT_DATAMODE"),
            ("selectable", "use_snap_selectable", "Привязка: Только к выделяемому", "Snap: Selectable Only", "RESTRICT_SELECT_OFF"),
            ("translate", "use_snap_translate", "Привязка: Перемещение", "Snap: Translation", "MOUSE_MOVE"),
            ("rotate", "use_snap_rotate", "Привязка: Вращение", "Snap: Rotation", "GESTURE_ROTATE"),
            ("scale", "use_snap_scale", "Привязка: Масштаб", "Snap: Scale", "ARROW_LEFTRIGHT"),
        ),
    ),
)


SEARCH_ACTIONS = ACTIONS + VIEWPORT_TOGGLE_ACTIONS
