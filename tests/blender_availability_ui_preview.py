"""Open and capture the menu-availability dialog for visual QA."""
...
def open_dialog():
    ...
    menu.allowed_modes = {"OBJECT", "SCULPT", "PARTICLE"}
    ...
    print("PIE_CUSTOMIZER_AVAILABILITY_DIALOG", result)
    return None


def capture_dialog():
    bpy.ops.screen.screenshot(filepath=str(SCREENSHOT_PATH))
    print("PIE_CUSTOMIZER_AVAILABILITY_SCREENSHOT", SCREENSHOT_PATH)
    return None
